    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'db.connection' => \MongoDB\Laravel\Connection::class,
            'db.factory' => \Illuminate\Database\Connectors\ConnectionFactory::class,
            'db.schema' => \MongoDB\Laravel\Schema\Builder::class,
    ...
    override(\config(), map([
            ...
            'database.connections.mongodb.url' => 'string',
            'database.connections.mongodb.host' => 'string',
            'database.connections.mongodb.port' => 'string',
            ...
            'filesystems.links.H:\Indicadores academicos\Backend-indicadores\public\storage' => 'string',
            ...
            'sanctum.middleware.authenticate_session' => 'boolean',
            'sanctum.personal_access_token_model' => 'string',
            'scribe.title' => 'string',
...
'restore','forceDelete','viewReadableDocument','viewCreableDocument',);
...
'database.connections.sqlsrv.password','database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.mongodb.driver',
'database.connections.mongodb.url','database.connections.mongodb.host','database.connections.mongodb.port','database.connections.mongodb.database','database.migrations.table',
...
'filesystems.links.H:\\Indicadores academicos\\Backend-indicadores\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'sanctum.middleware.authenticate_session','sanctum.personal_access_token_model','scribe.title','scribe.description','scribe.base_url',
...
'scribe.auth.use_value','scribe.auth.placeholder','scribe.auth.extra_info','scribe.intro_text','scribe.example_languages',
...
'view.compiled','excel.exports.chunk_size','excel.exports.pre_calculate_formulas','excel.exports.strict_null_comparison','excel.exports.csv.delimiter',
...
'signed','throttle','verified','auth.sanctum','abilities',
'checkDocumentAbility',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','storage.local',);
        registerArgumentsSet('views', 
'pdfs.invoice','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','H:.Indicadores academicos.Backend-indicadores.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_USERNAME','DB_PASSWORD','SESSION_DRIVER','BROADCAST_CONNECTION','FILESYSTEM_DISK',
