...
namespace Illuminate\Support\Facades {
    ...
    class DB {
         ...
         * @static
         */
        public static function setRenameEmbeddedIdField($rename)
        {
            /** @var \MongoDB\Laravel\Connection $instance */
            return $instance->setRenameEmbeddedIdField($rename);
        }
         ...
         * @static
         */
        public static function getRenameEmbeddedIdField()
        {
            /** @var \MongoDB\Laravel\Connection $instance */
            return $instance->getRenameEmbeddedIdField();
        }
    ...
    class Response {
         ...
         * @static
         */
        public static function success($message, $data = null, $resource = 'data', $status = 200)
        {
            return \Illuminate\Routing\ResponseFactory::success($message, $data, $resource, $status);
        }
         ...
         * @static
         */
        public static function fail($message, $data = null, $resource = 'data', $status = 400)
        {
            return \Illuminate\Routing\ResponseFactory::fail($message, $data, $resource, $status);
        }
         ...
         * @static
         */
        public static function error($message, $data = null, $resource = 'data', $status = 500)
        {
            return \Illuminate\Routing\ResponseFactory::error($message, $data, $resource, $status);
        }
         ...
         * @static
         */
        public static function created($message, $data = null, $resource = 'data')
        {
            return \Illuminate\Routing\ResponseFactory::created($message, $data, $resource);
        }
         ...
         * @static
         */
        public static function updated($message, $data = null, $resource = 'data')
        {
            return \Illuminate\Routing\ResponseFactory::updated($message, $data, $resource);
        }
        ...
        {
            return \Illuminate\Routing\ResponseFactory::deleted($message);
        }
         ...
         * @static
         */
        public static function validationError($errors, $message = 'Error de validación', $resource = 'data')
        {
            return \Illuminate\Routing\ResponseFactory::validationError($errors, $message, $resource);
        }
    ...
    class Schema {
        ...
        /**
         * @inheritdoc Drops the entire database instead of deleting each collection individually.
         * 
         ...
         * @static
         */
        public static function getTableListing($schema = null, $schemaQualified = false)
        {
            /** @var \MongoDB\Laravel\Schema\Builder $instance */
         ...
         * @static
         */
        public static function isAtlasSearchNotSupportedException($e)
        {
            return \MongoDB\Laravel\Schema\Builder::isAtlasSearchNotSupportedException($e);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder 
            return \MongoDB\Laravel\Schema\Builder::defaultTimePrecision($precision);
        }
